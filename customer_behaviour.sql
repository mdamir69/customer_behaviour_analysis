...
select subscription_status,count(customer_id) as total_customers, sum(purchase_amount) as total_revenue,avg(purchase_amount) as average_spend
from customer_shopping_data
...
-- Q7. Segment customers into New, Returning, and Loyal based on their total number of previous purchases, and show the distribution.
